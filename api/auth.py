...
async def usuario_atual(
    ...
    Não existe caminho alternativo de identidade. Um bypass por header
    (`X-User-Id`) chegou a existir sob `DEMO_MODE` e foi removido: uma
    variável de ambiente errada concedia superadmin de qualquer tenant a
    qualquer request.
    """
    if not token:
